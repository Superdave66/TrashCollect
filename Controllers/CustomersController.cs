...
;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FirstName,LastNAme,Adress,City,State,ZipCode,PickUpDate,Balance,Monthlycharge,PickupConfirmed,StartDate,EndDate")] Customer customer)
        {
            if (ModelState.IsValid)
            {
